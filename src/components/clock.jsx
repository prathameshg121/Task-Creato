  ...
  return (
    <div className="outer">
      <div className="clockArea">
        ...
        {displayDate ? (
          <h3>
            {date} {monthNames[month]} {year} {days[day]}
          </h3>
        ) : (
          ""
        )}
        ...
        <h1>
          {t}{" "}
          {display ? (
            <dfn title="close alarm">
              <AlarmOffIcon style={{ color: "#FF0000" }} onClick={showAlarm} />
            </dfn>
          ) : (
            <dfn title="show alarm">
              <AccessAlarmsIcon color="primary" onClick={showAlarm} />
            </dfn>
          )}
        </h1>
        {display ? <Reminder /> : ""}
